...
""定义函数SetTitle，自动插入文件头 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+1, "\# Author: 51CC_baosongshan") 
        call append(line(".")+2, "\# mail: baosongshan2006@163.com") 
        ...
        call append(line(".")+2, "*    > Author: 51CC_baosongshan") 
        call append(line(".")+3, "*    > Mail: baosongshan2006@163.com ") 
